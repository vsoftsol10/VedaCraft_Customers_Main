...
const sendBrevoEmail = async ({ email, subject, html }) => {
  ...
  const response = await getBrevoClient().transactionalEmails.sendTransacEmail({
    sender: {
      name: process.env.BREVO_SENDER_NAME || 'VedaCraft',
      ...
      <div style="font-family: Arial, sans-serif; max-width: 520px; margin: 0 auto; color: #1f2937;">
        ...
        <div style="border: 1px solid #e5e7eb; border-radius: 10px; padding: 24px;">
          ...
          <p style="margin: 0 0 18px; line-height: 1.5;">
            Use this one-time password to sign in to your VedaCraft account.
          </p>
...
export const sendOrderConfirmationEmail = async ({
  ...
  try {
      ...
      ">
        ...
        <div style="padding: 20px;">
          ...
          <p>
            ...
            for delivery. Below are the details of your order.
          </p>
          ...
          <h3 style="
            color: #2c3e50;
            border-bottom: 2px solid #1c6b32;
            padding-bottom: 5px;
          ">
            Order Summary
          </h3>
          ...
          ">
            ...
            <p style="
              ...
              color: #666;
            ">
              Thank you for shopping with VedaCraft!
            </p>
    ...
    // Don't interrupt the order process
  }
};
